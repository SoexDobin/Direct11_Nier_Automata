...
#define LOG_TRACE(fmt, ...)                                                    \
  Engine::SpdLogger::Trace(std::format(fmt, __VA_ARGS__))
#define LOG_DEBUG(fmt, ...)                                                    \
  Engine::SpdLogger::Debug(std::format(fmt, __VA_ARGS__))
#define LOG_INFO(fmt, ...)                                                     \
  Engine::SpdLogger::Info(std::format(fmt, __VA_ARGS__))
#define LOG_WARN(fmt, ...)                                                     \
  Engine::SpdLogger::Warn(std::format(fmt, __VA_ARGS__))
#define LOG_ERROR(fmt, ...)                                                    \
  Engine::SpdLogger::Error(std::format(fmt, __VA_ARGS__))
#define LOG_CRITICAL(fmt, ...)                                                 \
  Engine::SpdLogger::Critical(std::format(fmt, __VA_ARGS__))
#else
