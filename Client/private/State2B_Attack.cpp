...
State2B_Attack::State2B_Attack(const wstring& tag, const Shared<P10000Body>& owner)
	: State2B{tag, owner}
{
}
...
Shared<State2B_Attack> State2B_Attack::Create(const wstring& tag, const Shared<P10000Body>& owner)
{
