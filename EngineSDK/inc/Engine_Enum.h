...
enum class PROTOTYPE { OBJECT, GAMEOBJECT, COMPONENT, LEVEL, ENGINE_MANAGER, FONT, SHADOW };
enum class RENDERGROUP { PRIORITY, SHADOW, NONLIGHT, NONBLEND, BLEND, WORLDUI , UI, END };
...
enum class GAMEOBJECTTYPE { GAMEOBJECT, CAMERA, UI, CONTAINER, PART, WORLDUI, END, LIGHT, };
