...
{
	m_EnterAnim.emplace(Pl0000::PL0000_STATE::DASH_F);
	m_EnterAnim.emplace(Pl0000::PL0000_STATE::DASH_B);
	m_EnterAnim.emplace(Pl0000::PL0000_STATE::DASH_R);
	m_EnterAnim.emplace(Pl0000::PL0000_STATE::DASH_L);

	m_ToSprint.emplace(Pl0000::PL0000_STATE::JUMP_TO_SPRINT);
	m_ToSprint.emplace(Pl0000::PL0000_STATE::DASH_F_TO_SPRINT);
	m_ToSprint.emplace(Pl0000::PL0000_STATE::DASH_B_TO_SPRINT);
	m_ToSprint.emplace(Pl0000::PL0000_STATE::DASH_R_TO_SPRINT);
	m_ToSprint.emplace(Pl0000::PL0000_STATE::DASH_L_TO_SPRINT);
...
Bool State2B_Sprint::StateEnterInvoke()
{
	...
	{
		switch (auto animIndex = pl0000->Get_ModelComponent()->Get_AnimationIndex())
		{
