...
public:
	...
	Byte Get_DIMouseState(DIMB buttonID) const { return m_MouseState.rgbButtons[ETOI(buttonID)]; }
	Long Get_DIMouseMove(DIMM mouseState) { return *(reinterpret_cast<Long*>(&m_MouseState)) + static_cast<uint32>(mouseState); }
