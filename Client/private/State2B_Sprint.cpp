...
State2B_Sprint::State2B_Sprint(const wstring& tag, const Shared<P10000>& owner)
	: State2B{tag, owner}
{
}
...
Shared<State2B_Sprint> State2B_Sprint::Create(const wstring& tag, const Shared<P10000>& owner)
{
