...
Shared<GraphicDevice> GraphicDevice::Create(_In_ HWND hWnd, WINMODE isWindowed, uint32 winSizeX, uint32 winSizeY,
											_Out_ ComPtr<ID3D11Device>& device, 
											_Out_ ComPtr<ID3D11DeviceContext>& context)
{
	auto pInstance = make_shared<GraphicDevice>();
